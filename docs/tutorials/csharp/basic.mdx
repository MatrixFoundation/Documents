---
sidebar_label: C# Basic
title: Getting Started with C# Basic
sidebar_position: 1
---
...
`const` variables should be used when you need to define a variable that doesn’t change throughout the program’s life cycle.<br />
